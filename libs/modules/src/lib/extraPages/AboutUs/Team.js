...
import { StyledTeamCard, StyledTeamSliderInfo, StyledTeamSliderThumb, StyledTeamSliderView } from "./index.styled";
            ...
            return (
              <StyledTeamSliderInfo key={member.id}>
                <StyledTeamSliderThumb>
                  <AppImage src={member.image} alt='about us' title='aboutUs' />
                </StyledTeamSliderThumb>
                <h5>{member.name}</h5>
