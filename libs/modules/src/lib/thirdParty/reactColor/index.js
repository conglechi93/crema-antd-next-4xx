    ...
    <>
      ...
      <AppRowSimpleContainer>
        ...
        <Col xs={24} xl={12} key='reactColor-k'>
          <AppComponentCard title='Material Picker' component={MaterialPicker} />
        </Col>
        ...
        <Col xs={24} xl={12} key='reactColor-q'>
          <AppComponentCard title='Photoshop Picker' component={PhotoshopPicker} />
        </Col>
        <Col xs={24} xl={12} key='reactColor-r'>
          <AppComponentCard title='Swatches Picker' component={SwatchesPicker} />
        </Col>
      </AppRowSimpleContainer>
    </>
  );
